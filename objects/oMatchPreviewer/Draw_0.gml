draw_sprite_stretched(sprRKCTextBox,0,0,600,1300,300);
draw_text_ext(border,650,call,45,1200);

var op1w = string_width(response1)+(border*2);
//dimensions of response1 textbox [x1,y1,x2,y2]
var op1D = [1300-op1w,330,1300,465];
...
var op2D = [1300-op2w,465,1300,600];
...
draw_sprite_stretched(sprRKCTextBox,0,1300,0,300,900);