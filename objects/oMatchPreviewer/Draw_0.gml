...
draw_sprite_stretched(sprRKCTextBox,0,curX,750,1620,330);
draw_text_ext(curX+border,800,call,45,1200);

var op1w = string_width(response1)+(border*2);
//dimensions of response1 textbox [x1,y1,x2,y2]
var op1D = [curX+1620-op1w,480,curX+1620,615];
...
var op2D = [curX+1620-op2w,615,curX+1620,750];
...
draw_sprite_stretched(sprRKCTextBox,0,curX+1620,0,300,1080);